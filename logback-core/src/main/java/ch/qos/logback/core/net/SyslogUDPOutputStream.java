...
/**
 * SyslogUDPOutputStream is a wrapper around the {@link DatagramSocket} class so that it
 * behaves like an {@link OutputStream}.
 */
public class SyslogUDPOutputStream extends OutputStream implements SyslogOutputStream {
  ...
  public SyslogUDPOutputStream(String syslogHost, int port) throws UnknownHostException,
      SocketException {
